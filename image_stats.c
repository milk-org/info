    ...
    if (ID != -1)
        {
            ...
            tmp_long = data.image[ID].md[0].nelement *
            ...
            for (j = 1; j < data.image[ID].md[0].naxis; j++)
                {
                    ...
                    sprintf(vname, "imsize%ld", j);
                    create_variable_ID(vname,
                                       1.0 * data.image[ID].md[0].size[j]);
                }
            printf(" ]\n");
